...
def create_dash(flask_app):
        ...
        def store_data(n_intervals): 
                if n_intervals == 0:
                    ...
                    #filename = 'D://development//flask//stock//data//2022-06-27 NQ=Fout_stock_data.csv'
                    filename = '2022-06-28 NQ=Fout_stock_data.csv'
                    cwd = os.getcwd()
                    ...
                    FILE_PATH = os.path.join(os.path.dirname(os.path.abspath(file )), filename)                
