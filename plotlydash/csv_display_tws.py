...
def create_dash(flask_app):
        app=dash.Dash(server=flask_app, name="stock_dash", url_base_pathname=("/csv_display_tws/"), prevent_initial_callbacks=True)
        #app = Dash(__name__, suppress_callback_exceptions=True)

        app.layout = html.Div([
            html.H1('Dashboard of Excel TWS Data', style={'textAlign': 'center', "font-size":"20px"}),
            dcc.Upload(
                id='upload-data',
                children=html.Div([
                    'Drag and Drop or ',
