...
def create_dash(flask_app):
        ...
        @cc.callback([
                ...
                Output('tot_tbuy', 'children'),
                Output('tot_tsell', 'children'),
                Output('buy_tcount', 'children'),
                Output('sell_tcount', 'children'),
                Output('buy', 'children'),
        ...
        @cc.callback(
                    ...
                    [Input('update_value', 'n_intervals'),
                     Input('tot_tbuy', 'children'),
                     Input('tot_tsell', 'children'),
                     Input('buy_tcount', 'children'),
                     Input('sell_tcount', 'children'),])
