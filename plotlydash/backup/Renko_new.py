...
def create_dash(flask_app):
        ...
        def update_df(n_intervals):
                if n_intervals == 0:
                    ...
                    #filename = "2022-11-03 NQ=F USTime_feather_stock_data.feather"
                    cwd = os.getcwd()
        ...
        def maxminline_strategy(n_intervals, data):
                if n_intervals == 0:
                    ...
                    Sell[60] = df.Close[60]
                    T_Sell[60] = df.Close[60]
                    
                    #### assign Buy/Sell to df
                    Buy_list = list(Buy)
